/*
	...
	*/
	...
	/** load javascripts **/
	var alohaEditorPath = '/prototype/js/aloha/';
...
/*
	...
	*/
	loadJS("/prototype/js/vendor/jquery-1.7.2.js");
...
// config for Bills Drafting
loadJS(alohaEditorPath + 'config/bills-drafting.js');

// load Aloha Editor
loadJS( alohaEditorPath + 'aloha-bare.js', 	'common/ui, \
	common/format, \
	common/table, \
	common/list, \
	common/link,  \
...
loadJS('js/aloha-read-from-backend.js');
