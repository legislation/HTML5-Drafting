...
(function() {
  ...
  define(['aloha', 'aloha/plugin', 'jquery', 'overlay/overlay-plugin', 'ui/ui','ui/button', 'copy/copy-plugin', 'css!math/css/math.css'], function(Aloha, Plugin, jQuery, Popover, UI, Button, Copy) {
